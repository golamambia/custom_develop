...
include('includes/admin_top.php');
    ...
    if(isset($deleteid) && $deleteid!=""){
        $db->deleteData(TABLE_CHALLANSL,"id=".$deleteid);
        $db->deleteData(TABLE_CHALLAN_PARTSL,"challan_id=".$deleteid);
...
<div class="wrapper">
    ...
    <table id="example1" class="table table-bordered table-striped tableGrid">
        <thead>
        <a href="item_challanSL_add.php" type="button" class="btn btn-info">Add</a>
            <tr>
        ...
        <tbody>
            <?php 
            $sql = "SELECT * FROM ".TABLE_CHALLANSL." ORDER BY id DESC";
            ...
            <tr>
                ...
                <td>
                    <a href="item_challanSL_edit.php?edit=<?php echo $row_rec['id']; ?>" title="Edit"><img src="images/pencil.png" width="16" height="16" alt=""></a>
                    <a href="item_challanSL_list.php?delete=<?php echo $row_rec['id']; ?>" title="Delete"  onClick="return confirm('Are you sure you to delete this data?');">
