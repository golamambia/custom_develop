...
include('includes/admin_top.php'); 
    ...
    // $id = $_REQUEST['id'];
$rc=mysql_fetch_assoc(mysql_query("SELECT * FROM ".TABLE_CHALLAN." WHERE id=(SELECT MAX(id) FROM ".TABLE_CHALLAN.")"));
     $rc_no=$rc['no']+1;
    if(isset($_POST['add_work']) && $_POST['add_work']=='add_work'){
        ...
        $get_last_id = $db->insertDataArray(TABLE_CHALLAN,$_POST);
        ...
        for($count=0;$count<count($checkbox1);$count++)
        {
            ...
            //$chk.=$count;
            $get_last_id2 = $db->insertDataArray(TABLE_CHALLAN_PART,$data);
        }
...
<div  style="float: right;margin-right: 20px; cursor: pointer;" onclick="add_item_po();">
            ...
            <a href="item_challan_list.php" type="button" class="btn btn-info">Back</a>
