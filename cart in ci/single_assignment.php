                ...
                <h3>Solution preview</h3>
                    ...
                    <div class="sol_bottom_img">
                        <p style="text-align:center;">
                         ...
                         <a href="javascript:void(0)" data-productname="<?php echo $assignment['question_title'];?>" data-productid="<?php echo $assignment['sr_no'];?>" data-price="<?php echo $assignment['price'];?>" data-subject="<?php echo $assignment['name'];?>" class="adcrtpop popbtn add_cart">
...
">No Data</td>
 ...
 <?php  }
  ?>
                ...
                <!--    </fieldset>-->
                <!--</form>-->
                         <a id="process" href="<?=base_url('user/profile') ?>" style="cursor:pointer;">proceed to checkout</a>
                         <?php } ?>
                         </span>
                    </div>
